			...
			<ul class="nav">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="#" id="std-list">Student List</a></li>
						<li><a href="#content-area" id="std-create">Add student</a></li>
						<li><a href="#" id="std-delete">Delete Student</a></li>
						<li><a href="#" id="std-update">Update </a></li>
						<li><a href="#" id="std-swap">Swap Students</a></li>
					</ul>
				</li>
				<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li><a href="#" id="rm-delete">Clear Room</a></li>
						<li><a href="#" id="rm-update">Update </a></li>
					</ul>
				</li>
			</ul>
