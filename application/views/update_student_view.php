...
<div id="confirmation" class="modal hide fade in" style="display: none; ">
	...
	<div class="modal-footer">
		<a href="#" class="btn btn-success" id="add-student" data-dismiss="modal"> Confirm &amp; update  </a>
...
<div class="span7">
	<form class="form-horizontal" action="<?php echo site_url('student'); ?>/check_update" method="post" accept-charset="utf-8" enctype="multipart/form-data">
		...
		<div class="control-group">
			...
			<div class="span4">
				<input name="student-no" id="student-no" type="text" class="input-xlarge" value="<?php echo $id;?>"/>
			</div>
		</div>
		<div class="control-group">
...
<script>
	$(document).ready(function(){
		...
		$("#add-student").click(function(){
			$.post("<?php echo site_url('student')?>/check_update",{
				name:$("#name").val(),
				dept:$("#dept").val(),
				level:$("#level").val(),
				term:$("#term").val(),
